...
def find_specific_sv(unspecific_sv: UnspecificSV,
    ...
    for chr_id in chromosomes:
        ...
        inversion = check_translocation_or_inversion(unspecific_sv, chromosomes[chr_id],
                                                     inversion_test=current_sv, thr=translocation_thr)
...
def merge_to_heterozygous(reference_bnx_path: str,
    ...
    sv_bnx.bnx_arrays = ref_lines[:-1] + list(sv_bnx_lines.values())[1:]
    if file_write:
        sv_bnx.write_arrays_as_bnx(f"{sv_bnx_path}.heterozygous.bnx")
